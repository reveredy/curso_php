<nav class="modulos">
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=desafio_modulo">Desafio do Módulo</a>
            </li>
        </ul>
    </div>
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=modificador_final">Modificador final</a>
            </li>
            <li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=funcoes&file=escopo">Funcão e Escopo</a>
            </li>
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=funcoes&file=func_anonimas">Funções Anônimas</a>
            </li>
            <li>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_tabela_2">Desafio Tabela #2</a>
            </li>
        </ul>
    </div>
